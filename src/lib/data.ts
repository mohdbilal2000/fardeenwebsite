...
export const tours: Tour[] = [
  {
    id: "taj-sunrise",
    name: "Sunrise Taj Mahal Experience",
    category: "same-day",
    duration: "12 Hours",
    price: 40,
    originalPrice: 58,
  ...
  {
    id: "delhi-overnight",
    name: "Delhi to Agra VIP Transfer",
    category: "same-day",
    duration: "21 Hours",
    price: 84,
    originalPrice: 120,
  ...
  },
  {
    ...
    image: "/images/goldentriangle/gt-1.jpeg",
  },
  {
    id: "golden-4day",
    ...
    image: "/images/goldentriangle/gt-2.jpeg",
  },
  {
    id: "golden-5day",
    name: "Royal Mughal Experience",
    category: "golden-triangle",
    ...
    image: "/images/goldentriangle/gt-3.jpeg",
  },
  {
    id: "golden-tiger",
    ...
    image: "/images/goldentriangle/gt-4.jpeg",
  },
  {
    id: "golden-udaipur",
    ...
    image: "/images/goldentriangle/gt-5.jpeg",
  },
  {
    id: "rajasthan-7day",
  ...
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1661901647310-4deafc6f29a5?w=800&q=80",
  },
  {
    id: "rajasthan-9day",
    ...
    image: "https://plus.unsplash.com/premium_photo-1661904165347-369200d4bf72?w=800&q=80",
  },
  {
    id: "rajasthan-12day",
  ...
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1697730429201-381b71f61427?w=800&q=80",
  },
  {
    id: "agra-wildlife",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1717761558642-32cbeccbee7e?w=800&q=80",
  },

  // ===== KERALA TOURS =====
  {
    id: "kerala-backwaters-5day",
    name: "Kerala Backwaters & Beaches 5 Day Tour",
    category: "kerala",
    duration: "5 Days / 4 Nights",
    price: 450,
    originalPrice: 650,
    currency: "USD",
    description: "Experience the enchanting backwaters of Kerala on a traditional houseboat, explore Munnar's tea gardens, and unwind on the pristine beaches of Kovalam.",
    longDescription: "Kerala — God's Own Country — offers a uniquely serene travel experience in southern India. This 5-day journey takes you through the emerald tea plantations of Munnar, the tranquil backwaters of Alleppey aboard a traditional houseboat, and the golden beaches of Kovalam. Witness traditional Kathakali dance, savor authentic Malayali cuisine, and experience the slow, soulful rhythm of coastal Kerala life.",
    highlights: ["Houseboat stay in Alleppey", "Munnar tea plantations", "Kovalam beach relaxation", "Kathakali dance performance"],
    included: ["4 nights accommodation (hotel + houseboat)", "Daily breakfast", "Private AC vehicle with driver", "Houseboat with all meals", "Tea plantation visit", "Kathakali show", "Airport pickup & drop-off", "All applicable taxes"],
    excluded: ["Lunch and dinner (except on houseboat)", "Personal expenses", "Tips and gratuities", "Domestic flights"],
    itinerary: [
      { day: "Day 1", title: "Arrive Cochin — Drive to Munnar", description: "Arrive at Cochin International Airport where our representative welcomes you and begins the scenic 4-hour drive to Munnar, the famed hill station nestled at 1,600 meters in the Western Ghats. The journey winds through lush spice plantations, dense tropical forests, and cascading waterfalls. Check into your hotel surrounded by rolling tea plantations and enjoy the cool mountain air. Evening free to explore the local markets and taste Kerala's spiced tea at a local plantation café. Overnight in Munnar." },
      { day: "Day 2", title: "Munnar Sightseeing", description: "After breakfast, explore the breathtaking beauty of Munnar. Visit the Tata Tea Museum to learn about the fascinating history of tea cultivation in India and watch the processing from leaf to cup. Continue to Mattupetty Dam with its panoramic reservoir views, Echo Point where your voice returns as crystal-clear echoes, and Kundala Lake for optional boating amidst hills. Visit Eravikulam National Park, home to the endangered Nilgiri Tahr mountain goats, with views of Anamudi Peak — South India's highest mountain. Evening at leisure in your hotel. Overnight in Munnar." },
      { day: "Day 3", title: "Munnar to Alleppey — Houseboat Check-in", description: "Drive to Alleppey (Alappuzha), the 'Venice of the East,' through a scenic 4-hour route dotted with rubber plantations and traditional Kerala villages. Board your private traditional Kettuvallam houseboat — a beautifully crafted wooden vessel with palm-thatched roof, bedrooms, kitchen, and open deck. Cruise through the legendary Kerala backwaters: a vast network of interconnected canals, lagoons, and lakes fringed by coconut palms. Watch local life unfold on the banks — fishermen casting nets, women washing clothes, children swimming. Enjoy freshly cooked authentic Kerala meals onboard including the famous karimeen pollichathu (pearl spot fish) and appam. Overnight on the houseboat anchored in a peaceful lagoon under a blanket of stars." },
      { day: "Day 4", title: "Alleppey to Kovalam", description: "After a leisurely breakfast onboard watching the sunrise over the backwaters, disembark and drive to Kovalam beach (approximately 4 hours), Kerala's premier beach destination. Check into a beachfront resort and spend the afternoon relaxing on the famous Lighthouse Beach with its curving coastline of golden sand. Try an optional traditional Ayurvedic massage — Kerala is the birthplace of this ancient healing science. Watch the spectacular sunset over the Arabian Sea. Evening: enjoy fresh seafood at a beachside shack. Overnight in Kovalam." },
      { day: "Day 5", title: "Kovalam — Departure", description: "Morning at leisure on the beach. Visit the iconic Vizhinjam Lighthouse with panoramic coastal views (optional). After breakfast, drive to Trivandrum International Airport (approximately 45 minutes) for your onward departure with memories of Kerala's timeless beauty." },
    ],
    image: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800&q=80",
  },
  {
    id: "kerala-complete-7day",
    name: "Complete Kerala 7 Day Tour",
    category: "kerala",
    duration: "7 Days / 6 Nights",
    price: 650,
    originalPrice: 900,
    currency: "USD",
    description: "The ultimate Kerala experience covering Cochin's history, Munnar's hills, Thekkady's wildlife, Alleppey's backwaters, and Kovalam's beaches.",
    longDescription: "Seven days to experience every facet of Kerala — from colonial Cochin to the spice-scented hills of Thekkady, the tea plantations of Munnar, the serene backwaters of Alleppey, and the beaches of Kovalam. This comprehensive journey includes a wildlife safari at Periyar, houseboat stay, Kathakali performance, Ayurvedic spa experience, and traditional meals throughout.",
    highlights: ["Fort Cochin heritage walk", "Periyar Wildlife Sanctuary", "Munnar tea estates", "Alleppey houseboat cruise", "Kovalam beach stay", "Ayurvedic wellness session"],
    included: ["6 nights accommodation", "Daily breakfast", "Houseboat with all meals", "Private AC vehicle with driver", "Periyar boat safari", "Kathakali & Kalaripayattu shows", "Airport transfers", "All taxes"],
    excluded: ["Lunch and dinner (except houseboat)", "Spa treatments", "Personal expenses", "Tips and gratuities"],
    itinerary: [
      { day: "Day 1", title: "Arrive Cochin", description: "Arrive at Cochin International Airport where our representative welcomes you. Check into your heritage hotel in Fort Cochin. Afternoon explore Fort Cochin on foot: visit the ancient Chinese Fishing Nets (Cheena Vala) introduced by Chinese traders in the 14th century, the historic St. Francis Church (India's oldest European church where Vasco da Gama was originally buried), the Santa Cruz Basilica, and Mattancherry Palace (Dutch Palace) with its exquisite murals depicting Hindu epics. Walk through Jew Town and the 16th-century Paradesi Synagogue. Evening Kathakali dance performance with explanation of the elaborate makeup and storytelling. Overnight in Cochin." },
      { day: "Day 2", title: "Cochin to Munnar", description: "Scenic 4-hour drive to Munnar passing through spice plantations of cardamom, pepper, and vanilla. Stop at Cheeyappara and Valara waterfalls. Check into your hotel and enjoy the cool mountain air. Evening walk through a tea plantation. Overnight in Munnar." },
      { day: "Day 3", title: "Munnar Sightseeing", description: "Full day exploring Munnar: Tata Tea Museum, Mattupetty Dam, Echo Point, Kundala Lake, and Eravikulam National Park with endangered Nilgiri Tahr. Enjoy panoramic views from Top Station. Overnight in Munnar." },
      { day: "Day 4", title: "Munnar to Thekkady", description: "Drive to Thekkady (approximately 3.5 hours), home to Periyar Wildlife Sanctuary and Tiger Reserve. Afternoon boat safari on Periyar Lake to spot elephants, bison, sambar deer, and if lucky, tigers. Evening: traditional Kalaripayattu martial arts performance. Overnight in Thekkady." },
      { day: "Day 5", title: "Thekkady to Alleppey — Houseboat", description: "Morning spice plantation walk learning about cardamom, pepper, nutmeg, and vanilla cultivation. Drive to Alleppey (approximately 4 hours) and board your private traditional Kettuvallam houseboat. Cruise through the famous Kerala backwaters enjoying authentic onboard meals. Overnight on houseboat." },
      { day: "Day 6", title: "Alleppey to Kovalam", description: "Disembark after breakfast and drive to Kovalam (approximately 4 hours). Afternoon on Lighthouse Beach. Optional Ayurvedic massage session. Overnight in Kovalam." },
      { day: "Day 7", title: "Kovalam — Departure", description: "Morning at leisure on the beach. Transfer to Trivandrum International Airport for onward journey." },
    ],
  ...
  // ===== KASHMIR TOURS =====
  {
    id: "kashmir-paradise-5day",
    name: "Kashmir Paradise 5 Day Tour",
    category: "kashmir",
    duration: "5 Days / 4 Nights",
    price: 480,
    originalPrice: 700,
    currency: "USD",
    description: "Experience the crown of India — stay in a Shikara houseboat on Dal Lake, visit Gulmarg's meadows, and explore the Mughal Gardens of Srinagar.",
    longDescription: "Kashmir, often called 'Paradise on Earth' and 'Heaven on Earth,' lives up to every poetic description. This 5-day journey takes you through the surreal beauty of Srinagar's Dal Lake on a traditional Shikara boat, to the snow-capped meadows of Gulmarg with its world-famous Gondola cable car, and through Mughal gardens that inspired Persian poetry. Stay aboard a luxurious houseboat, taste authentic Kashmiri Wazwan cuisine, and witness the warm hospitality of the valley's people.",
    highlights: ["Houseboat stay on Dal Lake", "Shikara ride", "Gulmarg Gondola cable car", "Mughal Gardens tour", "Pahalgam valley visit"],
    included: ["4 nights accommodation (hotel + houseboat)", "Daily breakfast and dinner", "Private AC vehicle with driver", "Shikara ride on Dal Lake", "Gulmarg Gondola ticket (Phase 1)", "Airport pickup & drop-off", "All taxes"],
    excluded: ["Lunch", "Gulmarg Gondola Phase 2", "Horse riding and pony charges", "Personal expenses", "Tips and gratuities"],
    itinerary: [
      { day: "Day 1", title: "Arrive Srinagar — Houseboat Check-in", description: "Arrive at Srinagar International Airport where our representative welcomes you. Transfer to your beautifully crafted wooden houseboat on the legendary Dal Lake. These traditional Kashmiri houseboats, crafted from deodar cedar and walnut wood, feature intricately carved interiors, antique furniture, and Persian carpets. Afternoon Shikara ride across Dal Lake — glide past floating vegetable gardens, traditional wooden homes built on stilts, the picturesque Char Chinar island with its 400-year-old Chinar trees, and colorful floating markets where vendors sell flowers, vegetables, and handicrafts directly from their boats. Watch the sun set over the surrounding snow-capped Himalayan peaks. Dinner aboard the houseboat featuring traditional Kashmiri cuisine. Overnight on houseboat." },
      { day: "Day 2", title: "Srinagar Sightseeing — Mughal Gardens", description: "After breakfast, explore Srinagar's famous Mughal Gardens, built by the Mughal emperors as pleasure retreats. Visit Nishat Bagh (Garden of Pleasure) built in 1633 by Asaf Khan, with its 12 terraced levels representing the zodiac signs and stunning views of Dal Lake. Continue to Shalimar Bagh (Garden of Love) built by Emperor Jahangir for his beloved wife Nur Jahan, featuring cascading fountains and Chinar trees. Visit Chashme Shahi (Royal Spring) known for its fresh water said to have medicinal properties. Afternoon visit Shankaracharya Temple perched atop a hill at 1,100 feet, offering panoramic views of the entire Srinagar valley and Dal Lake. Explore the old city bazaars for Kashmiri handicrafts: Pashmina shawls, walnut woodcarvings, papier-mâché items, and saffron. Overnight on houseboat." },
      { day: "Day 3", title: "Srinagar to Gulmarg — Day Trip", description: "Day excursion to Gulmarg (meaning 'Meadow of Flowers'), a pristine ski resort at 2,650 meters in the Pir Panjal range. The 2-hour drive through pine forests and apple orchards is spectacular. Ride the famous Gulmarg Gondola — one of the world's highest cable cars — to Kongdoori station (Phase 1) at 3,050 meters for breathtaking views of the Himalayas. Optional Phase 2 continues to Apharwat Peak at 3,979 meters (weather permitting). In summer, enjoy the lush green meadows dotted with wildflowers; in winter, witness the snow-covered wonderland that makes Gulmarg Asia's premier skiing destination. Optional pony rides through the meadows to Strawberry Valley and Ningli Nallah. Return to Srinagar by evening. Overnight on houseboat." },
      { day: "Day 4", title: "Srinagar to Pahalgam — Day Trip", description: "Day excursion to Pahalgam (meaning 'Valley of Shepherds') at 2,130 meters, a stunning hill station where the Lidder River flows through pine forests and meadows. The 2.5-hour drive passes through Sangam (confluence of Lidder and Arun rivers), the saffron fields of Pampore (producing the world's finest saffron), and Awantipura with its 9th-century Hindu temple ruins. Explore Betaab Valley (named after a Bollywood film) with its lush green meadows surrounded by snow-capped peaks and crystalline streams. Visit Aru Valley (12 km from Pahalgam), a picturesque meadow that serves as a base for trekkers heading to Kolahoi Glacier. Optional pony ride to Chandanwari, the starting point of the Amarnath Yatra pilgrimage. Return to Srinagar. Overnight on houseboat." },
      { day: "Day 5", title: "Srinagar — Departure", description: "Morning at leisure on the houseboat. Optional last-minute Shikara ride or shopping for Kashmiri specialties. Transfer to Srinagar International Airport for your onward journey with memories of Paradise on Earth." },
    ],
    image: "https://plus.unsplash.com/premium_photo-1691360599379-a5717853ab6e?w=800&q=80",
  },
  {
    id: "kashmir-complete-7day",
    name: "Complete Kashmir 7 Day Tour",
    category: "kashmir",
    duration: "7 Days / 6 Nights",
    price: 680,
    originalPrice: 950,
    currency: "USD",
    description: "The complete Kashmir experience covering Srinagar, Gulmarg, Pahalgam, and Sonmarg with houseboat stay and Mughal gardens.",
    longDescription: "Seven days to fully experience the crown of India. This comprehensive tour covers all four major destinations of the Kashmir Valley: Srinagar's Dal Lake and Mughal Gardens, Gulmarg's meadows and gondola, Pahalgam's valleys and rivers, and Sonmarg's glaciers. Stay in traditional houseboats and premium hotels, enjoy authentic Kashmiri Wazwan cuisine, and experience the legendary hospitality of the valley.",
    highlights: ["Dal Lake houseboat", "Gulmarg Gondola", "Pahalgam valleys", "Sonmarg Thajiwas Glacier", "Mughal Gardens", "Wazwan cuisine"],
    included: ["6 nights accommodation (hotel + houseboat)", "Daily breakfast and dinner", "Private AC vehicle", "Shikara ride", "Gulmarg Gondola Phase 1", "All transfers and taxes"],
    excluded: ["Lunch", "Gondola Phase 2", "Horse/pony charges", "Personal expenses", "Tips and gratuities"],
    itinerary: [
      { day: "Day 1", title: "Arrive Srinagar", description: "Arrive at Srinagar Airport, transfer to houseboat on Dal Lake. Afternoon Shikara ride with visits to floating gardens and Char Chinar. Overnight on houseboat." },
      { day: "Day 2", title: "Srinagar Sightseeing", description: "Full day exploring Mughal Gardens (Nishat Bagh, Shalimar Bagh, Chashme Shahi), Shankaracharya Temple, and the old city bazaars. Overnight on houseboat." },
      { day: "Day 3", title: "Srinagar to Gulmarg", description: "Drive to Gulmarg (2 hours), check into hotel. Ride the famous Gondola cable car to Kongdoori. Afternoon at leisure in the meadows or optional skiing in winter. Overnight in Gulmarg." },
      { day: "Day 4", title: "Gulmarg to Pahalgam", description: "Drive to Pahalgam (approximately 5 hours) through saffron fields of Pampore and Awantipura ruins. Check into hotel. Evening walk along the Lidder River. Overnight in Pahalgam." },
      { day: "Day 5", title: "Pahalgam Sightseeing", description: "Full day exploring Betaab Valley, Aru Valley, and Chandanwari. Optional pony rides and river activities. Overnight in Pahalgam." },
      { day: "Day 6", title: "Pahalgam to Sonmarg to Srinagar", description: "Drive to Sonmarg ('Meadow of Gold') via Srinagar. Visit Thajiwas Glacier (optional pony ride). Return to Srinagar for overnight on houseboat." },
      { day: "Day 7", title: "Srinagar — Departure", description: "Morning at leisure. Transfer to airport for onward departure." },
    ],
    image: "https://images.unsplash.com/photo-1623776025811-fd139155a39b?w=800&q=80",
  },

  // ===== SRI LANKA TOURS =====
  {
    id: "sri-lanka-highlights-5day",
    name: "Sri Lanka Highlights 5 Day Tour",
    category: "sri-lanka",
    duration: "5 Days / 4 Nights",
    price: 550,
    originalPrice: 780,
    currency: "USD",
    description: "Experience the best of Sri Lanka — the ancient rock fortress of Sigiriya, the sacred city of Kandy, tea country, and the golden beaches of Bentota.",
    longDescription: "A concentrated 5-day journey through Sri Lanka's cultural triangle and southern coast. Climb the UNESCO-listed Sigiriya Rock Fortress, visit the sacred Temple of the Tooth in Kandy, ride through the emerald tea plantations of the hill country, and relax on Bentota's palm-fringed beaches. Experience Sri Lankan hospitality, sample authentic cuisine, and witness one of Asia's most culturally rich destinations.",
    highlights: ["Sigiriya Rock Fortress climb", "Temple of the Tooth", "Tea plantation train ride", "Bentota beach", "Cultural dance show"],
    included: ["4 nights accommodation", "Daily breakfast", "Private AC vehicle with English-speaking driver-guide", "All monument entry fees", "Airport transfers", "All taxes"],
    excluded: ["International flights", "Lunch and dinner", "Personal expenses", "Tips and gratuities", "Sri Lanka visa fees"],
    itinerary: [
      { day: "Day 1", title: "Arrive Colombo — Drive to Sigiriya", description: "Arrive at Bandaranaike International Airport, meet your driver-guide, and drive to Sigiriya (approximately 4 hours). En route, visit the Pinnawala Elephant Orphanage established in 1975 to care for orphaned and injured wild elephants — watch them being fed and bathing in the river. Check into your hotel near Sigiriya Rock. Evening at leisure. Overnight in Sigiriya." },
      { day: "Day 2", title: "Sigiriya Rock — Dambulla — Kandy", description: "Early morning climb Sigiriya Rock Fortress (the 'Lion Rock'), a UNESCO World Heritage site built by King Kashyapa in the 5th century atop a 200-meter monolithic rock. Ascend through the Lion's Gate (giant carved lion paws are all that remain), past the famous Mirror Wall and the stunning frescoes of the Sigiriya Damsels, to the summit where you'll find remnants of the ancient palace with panoramic views over the jungle. Descend and visit Dambulla Cave Temple — a UNESCO site with five sacred caves containing 153 Buddha statues and beautiful ceiling paintings dating back 2,000 years. Continue to Kandy (approximately 2.5 hours), the last capital of the ancient Sinhalese kings. Evening witness a traditional Kandyan cultural dance show featuring fire-walking. Overnight in Kandy." },
      { day: "Day 3", title: "Kandy — Tea Country — Nuwara Eliya", description: "Morning visit the sacred Temple of the Tooth Relic (Sri Dalada Maligawa), which houses a tooth relic of Lord Buddha and is the most revered Buddhist shrine in Sri Lanka. Explore the Royal Botanical Gardens at Peradeniya with over 4,000 plant species. Afternoon drive through the stunning tea country to Nuwara Eliya (called 'Little England' for its British colonial architecture and cool climate). Visit a tea factory to see how the world-famous Ceylon tea is processed. Overnight in Nuwara Eliya at 1,868 meters elevation." },
      { day: "Day 4", title: "Scenic Train to Bentota Beach", description: "Morning take the legendary train journey from Nanu Oya to Ella (or Haputale) — widely considered one of the world's most scenic train rides, passing through emerald tea plantations, misty mountains, waterfalls, and hill villages (train journey optional based on schedule). Drive to Bentota beach (approximately 4-5 hours) on the southern coast. Afternoon relax on the golden sand beach. Overnight in Bentota." },
      { day: "Day 5", title: "Bentota — Colombo — Departure", description: "Morning optional water sports (jet ski, banana boat) or beach relaxation. Visit a turtle hatchery where endangered sea turtles are protected. Drive to Colombo for last-minute shopping at Odel or Dutch Hospital shopping complex. Transfer to Bandaranaike International Airport for departure." },
    ],
    image: "https://images.unsplash.com/photo-1586500036706-41963de24d8b?w=800&q=80",
  },
  {
    id: "sri-lanka-complete-8day",
    name: "Complete Sri Lanka 8 Day Tour",
    category: "sri-lanka",
    duration: "8 Days / 7 Nights",
    price: 850,
    originalPrice: 1200,
    currency: "USD",
    description: "The ultimate Sri Lanka journey — cultural triangle, tea country, Yala safari, Galle Fort, and southern beaches.",
    longDescription: "Eight days to fully experience the pearl of the Indian Ocean. This comprehensive journey covers the ancient cities of Anuradhapura and Polonnaruwa, the Sigiriya Rock Fortress, the sacred city of Kandy, the cool tea country of Nuwara Eliya, a thrilling jeep safari at Yala National Park, the colonial charm of Galle Fort, and relaxation on the southern beaches.",
    highlights: ["Sigiriya Rock Fortress", "Kandy Temple of the Tooth", "Tea country train ride", "Yala wildlife safari", "Galle Fort", "South coast beaches"],
    included: ["7 nights accommodation", "Daily breakfast", "Private vehicle with driver-guide", "Yala jeep safari", "All entry fees", "Airport transfers", "Taxes"],
    excluded: ["International flights", "Lunch and dinner", "Sri Lanka visa", "Personal expenses", "Tips"],
    itinerary: [
      { day: "Day 1", title: "Arrive Colombo — Sigiriya", description: "Airport pickup, drive to Sigiriya via Pinnawala Elephant Orphanage. Overnight Sigiriya." },
      { day: "Day 2", title: "Sigiriya Rock — Dambulla — Kandy", description: "Climb Sigiriya Rock Fortress, visit Dambulla Cave Temple, drive to Kandy. Evening cultural dance show. Overnight Kandy." },
      { day: "Day 3", title: "Kandy Sightseeing", description: "Visit Temple of the Tooth, Royal Botanical Gardens, spice garden. Overnight Kandy." },
      { day: "Day 4", title: "Kandy to Nuwara Eliya", description: "Scenic drive through tea country. Visit tea factory and plantations. Overnight Nuwara Eliya." },
      { day: "Day 5", title: "Nuwara Eliya to Yala", description: "Scenic train ride to Ella (optional). Drive to Yala. Evening jeep safari to spot leopards, elephants, sloth bears. Overnight Yala." },
      { day: "Day 6", title: "Yala to Galle", description: "Morning safari. Drive to Galle. Explore Galle Fort, a 16th-century Portuguese/Dutch colonial fortification. Overnight Galle." },
  ...
  {
    id: "mysore-coorg-3day",
    name: "Mysore & Coorg 3 Day Tour",
    category: "mysore",
    duration: "3 Days / 2 Nights",
    price: 220,
    originalPrice: 320,
    currency: "USD",
    description: "Explore the royal city of Mysore with its magnificent palace and then unwind in the coffee plantations of Coorg — the Scotland of India.",
    longDescription: "A perfect short getaway combining the royal heritage of Mysore — home to the breathtaking Mysore Palace — with the tranquil coffee plantations and misty hills of Coorg. Experience South Indian culture, cuisine, and nature in one compact tour.",
    highlights: ["Mysore Palace illumination", "Chamundi Hills", "Coorg coffee plantations", "Abbey Falls", "Dubare Elephant Camp"],
    included: ["2 nights accommodation", "Daily breakfast", "Private AC vehicle with driver", "All entry fees", "Bangalore pickup & drop-off", "All taxes"],
    excluded: ["Lunch and dinner", "Personal expenses", "Tips and gratuities", "Adventure activities"],
    itinerary: [
      { day: "Day 1", title: "Bangalore to Mysore", description: "Morning pickup from Bangalore. Drive to Mysore (approximately 3.5 hours) via Srirangapatna, the former capital of Tipu Sultan with historical sites like Ranganathaswamy Temple and Tipu's Summer Palace. Arrive in Mysore and visit the magnificent Mysore Palace (Amba Vilas) — one of India's most spectacular royal residences built in Indo-Saracenic style with stunning stained glass ceilings, intricate wood carvings, and lavish interiors. Visit Chamundi Hills with the Chamundeshwari Temple and the iconic Nandi bull statue. Evening witness the Palace illumination (on Sundays and festival days) when 97,000 bulbs light up the palace. Overnight in Mysore." },
      { day: "Day 2", title: "Mysore to Coorg", description: "Morning visit Brindavan Gardens at KRS Dam, famous for its musical fountain. Drive to Coorg/Madikeri (approximately 3 hours), the coffee capital of India nestled in the Western Ghats. Check into a coffee plantation resort. Afternoon visit Abbey Falls surrounded by coffee estates and spice plantations, Raja's Seat for panoramic sunset views over the valley, and Madikeri Fort. Overnight in Coorg." },
      { day: "Day 3", title: "Coorg — Return to Bangalore", description: "Morning visit Dubare Elephant Camp to interact with trained elephants — feed and bathe them in the Kaveri River. Visit a coffee plantation with guided tour explaining cultivation and roasting. Taste fresh plantation coffee. Drive back to Bangalore (approximately 5 hours) for drop-off." },
    ],
    image: "https://plus.unsplash.com/premium_photo-1697730494992-7d5a0c46ea52?w=800&q=80",
  },
  {
    id: "south-india-heritage-6day",
    name: "South India Heritage 6 Day Tour",
    category: "mysore",
    duration: "6 Days / 5 Nights",
    price: 480,
    originalPrice: 680,
    currency: "USD",
    description: "Discover the architectural wonders of South India — Bangalore, Mysore, Hassan (Belur/Halebidu), Hampi, and Coorg.",
    longDescription: "A six-day journey through Karnataka's most iconic heritage sites. Explore the Garden City of Bangalore, the royal splendor of Mysore, the intricate Hoysala temples of Belur and Halebidu, the UNESCO ruins of Hampi (the former Vijayanagara Empire capital), and the coffee plantations of Coorg.",
    highlights: ["Mysore Palace", "Hoysala temples (Belur & Halebidu)", "Hampi UNESCO ruins", "Coffee plantations", "Coorg hills"],
    included: ["5 nights accommodation", "Daily breakfast", "Private AC vehicle", "All entry fees", "Licensed guides", "Airport transfers", "Taxes"],
    excluded: ["Lunch and dinner", "Personal expenses", "Tips"],
    itinerary: [
      { day: "Day 1", title: "Arrive Bangalore", description: "Airport pickup. Bangalore sightseeing: Lalbagh Botanical Garden, Bangalore Palace, Vidhana Soudha, Cubbon Park. Overnight Bangalore." },
      { day: "Day 2", title: "Bangalore to Mysore", description: "Drive to Mysore via Srirangapatna. Visit Mysore Palace, Chamundi Hills, Brindavan Gardens. Overnight Mysore." },
      { day: "Day 3", title: "Mysore to Hassan", description: "Drive to Hassan via Shravanabelagola (Jain statue of Bahubali). Visit Belur Chennakeshava Temple and Halebidu Hoysaleshwara Temple — masterpieces of Hoysala architecture. Overnight Hassan." },
      { day: "Day 4", title: "Hassan to Hampi", description: "Long drive to Hampi (approximately 7 hours). Evening explore the sacred area with Virupaksha Temple. Overnight Hampi." },
      { day: "Day 5", title: "Hampi Sightseeing", description: "Full day at Hampi UNESCO site: Vittala Temple (Stone Chariot), Royal Enclosure, Lotus Mahal, Elephant Stables, Queen's Bath. Overnight Hampi." },
      { day: "Day 6", title: "Hampi to Bangalore — Departure", description: "Drive back to Bangalore for departure." },
    ],
    image: "https://plus.unsplash.com/premium_photo-1661963649278-db5e2697d0be?w=800&q=80",
  },

  // ===== ADDITIONAL RAJASTHAN TOURS =====
  {
    id: "jaipur-2day",
    name: "Jaipur Shopping & Culture 2 Day Tour",
    category: "rajasthan",
    duration: "2 Days / 1 Night",
    price: 130,
    originalPrice: 195,
    currency: "USD",
    description: "A focused 2-day Jaipur experience covering heritage forts, cultural experiences, and the city's famous bazaars and textile workshops.",
    longDescription: "Two days to experience the essence of the Pink City. Beyond the usual tourist spots, this tour takes you to block-printing workshops, gem-cutting studios, and the legendary textile bazaars where Rajasthan's craft traditions live on. Includes a traditional Rajasthani dinner with folk performance.",
    highlights: ["Amber Fort with elephant ride", "City Palace & Hawa Mahal", "Block printing workshop", "Johari Bazaar", "Traditional folk dinner"],
    included: ["1 night heritage hotel", "Breakfast", "Private AC car", "Licensed guide", "Entry tickets", "Elephant ride", "Folk performance dinner", "All taxes"],
    excluded: ["Lunch and Day 2 dinner", "Shopping expenses", "Personal expenses", "Tips"],
    itinerary: [
      { day: "Day 1", title: "Amber Fort & Old City", description: "Morning visit Amber Fort with elephant ride up to the entrance. Explore the Sheesh Mahal (Mirror Palace), Ganesh Pol, and Sukh Niwas. Visit Jal Mahal (water palace). Afternoon: block printing workshop in Sanganer village where artisans demonstrate the 500-year-old craft. Evening: City Palace museum, Hawa Mahal photo stop, and Johari Bazaar for gemstones and jewelry. Traditional Rajasthani thali dinner at Chokhi Dhani with folk dance performance. Overnight Jaipur." },
      { day: "Day 2", title: "Jantar Mantar & Markets", description: "Morning visit UNESCO-listed Jantar Mantar astronomical observatory. Visit a gem-cutting workshop and Anokhi Museum of Hand Printing. Afternoon shopping at Bapu Bazaar for textiles and Tripolia Bazaar for lac bangles. Transfer to Jaipur airport or drive back to Delhi." },
    ],
    image: "https://images.unsplash.com/photo-1477587458883-47145ed94245?w=800&q=80",
  },
  {
    id: "pushkar-jaipur-4day",
    name: "Jaipur & Pushkar Sacred Tour 4 Day",
    category: "rajasthan",
    duration: "4 Days / 3 Nights",
    price: 280,
    originalPrice: 420,
    currency: "USD",
    description: "Combine the royal heritage of Jaipur with the sacred pilgrimage town of Pushkar and its holy lake and Brahma Temple.",
    longDescription: "A spiritual and cultural journey covering Rajasthan's regal capital Jaipur and the sacred town of Pushkar — one of the oldest cities in India with the world's only temple dedicated to Lord Brahma. Experience aarti ceremonies by the holy Pushkar Lake, camel rides in the Thar Desert edge, and the colorful local bazaars.",
    highlights: ["Amber Fort", "Pushkar Lake aarti", "Brahma Temple", "Camel ride", "Local bazaars"],
    included: ["3 nights accommodation", "Daily breakfast", "Private AC car", "Guides", "Entry tickets", "Camel ride", "All taxes"],
    excluded: ["Lunch and dinner", "Personal expenses", "Tips"],
    itinerary: [
      { day: "Day 1", title: "Arrive Jaipur", description: "Arrive in Jaipur, check into hotel. Afternoon: City Palace, Jantar Mantar, Hawa Mahal. Evening: Chokhi Dhani cultural dinner. Overnight Jaipur." },
      { day: "Day 2", title: "Amber Fort & Jaipur", description: "Morning: Amber Fort with elephant ride. Jal Mahal and Nahargarh Fort for panoramic views. Afternoon at leisure or shopping. Overnight Jaipur." },
      { day: "Day 3", title: "Jaipur to Pushkar", description: "Drive to Pushkar (approximately 3 hours). Visit Pushkar Lake with its 52 ghats. Visit the sacred Brahma Temple — one of very few temples dedicated to Lord Brahma in the world. Evening aarti ceremony at the lake. Explore the colorful Pushkar bazaar for silver jewelry and embroidered textiles. Overnight Pushkar." },
      { day: "Day 4", title: "Pushkar — Return", description: "Morning camel ride at the edge of the Thar Desert. Drive to Jaipur airport or Delhi (approximately 6 hours to Delhi)." },
    ],
    image: "https://plus.unsplash.com/premium_photo-1697730426227-9056296a0315?w=800&q=80",
  },

  // ===== FOOD & HERITAGE WALKS =====
  {
    id: "old-delhi-food-walk",
    ...
    originalPrice: 65,
    currency: "USD",
    description: "A guided food expedition through the legendary streets of Old Delhi — Chandni Chowk, Paranthe Wali Gali, and Jama Masjid.",
    longDescription: "Old Delhi is India's greatest street food destination — a labyrinth of narrow lanes where recipes have been perfected over generations. This guided walking tour takes you through Chandni Chowk's spice markets, the legendary Paranthe Wali Gali with its 100-year-old paratha shops, the Mughlai kebab stalls of Jama Masjid, and hidden sweet shops known only to locals. Taste 10+ dishes with commentary on their history and cultural significance.",
    highlights: ["Paranthe Wali Gali", "Karim's Mughlai cuisine", "Spice market tour", "Jalebi Wala sweets", "Rickshaw ride"],
    included: ["Expert food guide", "All food tastings (10+ dishes)", "Bottled water", "Rickshaw ride through Chandni Chowk", "Tips on street food safety"],
    excluded: ["Hotel pickup/drop-off (available at extra cost)", "Additional food items ordered", "Alcoholic beverages"],
    itinerary: [
      { day: "10:00 AM", title: "Meet at Chandni Chowk Metro", description: "Meet your food guide at Chandni Chowk metro station. Brief introduction to Old Delhi's history and the food culture you're about to experience." },
      { day: "10:15 AM", title: "Paranthe Wali Gali", description: "Start with the legendary Paranthe Wali Gali where three shops have been serving stuffed parathas since the 1870s. Taste varieties like aloo, paneer, and the famous kaju (cashew) paratha served with tamarind chutney, banana pickle, and potato sabzi." },
      { day: "11:00 AM", title: "Spice Market (Khari Baoli)", description: "Walk through Asia's largest spice market. Learn about Indian spices, their medicinal uses, and watch porters carry massive sacks. Sample fresh masala chai at a traditional tea stall." },
      { day: "11:45 AM", title: "Jalebi Wala", description: "Visit the iconic Old Famous Jalebi Wala (since 1884) for hot, crispy jalebis fried in desi ghee — the perfect sweet crunch. Also taste daulat ki chaat, a seasonal winter delicacy made from frothed milk." },
      { day: "12:15 PM", title: "Natraj Dahi Bhalla", description: "Head to Natraj Dahi Bhalla (since 1940) for the most famous dahi bhalla and aloo tikki in Delhi. Learn about the art of Indian chaat." },
      { day: "12:45 PM", title: "Rickshaw to Jama Masjid", description: "Hop on a cycle rickshaw for a thrilling ride through Chandni Chowk's chaotic lanes to Jama Masjid — India's largest mosque built by Shah Jahan." },
      { day: "1:00 PM", title: "Karim's & Al Jawahar", description: "End with a feast at Karim's (since 1913) or Al Jawahar — the legendary Mughlai kebab and biryani institutions descending from Mughal royal cooks. Taste seekh kebab, mutton burra, and chicken jahangiri. Tour concludes here." },
    ],
    image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=800&q=80",
  },
  {
    id: "delhi-heritage-walk",
    name: "New Delhi Heritage Walk",
    category: "food-heritage",
    duration: "5 Hours",
    price: 55,
    originalPrice: 80,
    currency: "USD",
    description: "A guided walking tour through Lutyens' Delhi, Humayun's Tomb, and the Sufi shrine of Nizamuddin Dargah.",
    ...
    highlights: ["Lutyens' Delhi architecture", "Humayun's Tomb UNESCO site", "Nizamuddin Dargah Sufi shrine", "Qawwali music (Thursdays)", "Historical commentary"],
    included: ["Expert heritage guide", "Monument entry fees", "Bottled water", "Transportation between sites"],
    excluded: ["Meals", "Personal expenses", "Tips", "Hotel pickup (available extra)"],
    itinerary: [
      { day: "9:00 AM", title: "India Gate & Rajpath", description: "Begin at India Gate, the 42-meter war memorial commemorating 82,000 Indian soldiers who died in WWI. Walk along Rajpath to view Rashtrapati Bhavan (President's House) and North/South Block." },
      { day: "10:00 AM", title: "Humayun's Tomb", description: "Visit Humayun's Tomb (1570) — the first grand garden tomb in the Indian subcontinent and the inspiration for the Taj Mahal. Explore the complex including the tomb of Isa Khan and the beautifully symmetric Charbagh gardens." },
      { day: "12:00 PM", title: "Nizamuddin Dargah", description: "Walk to the nearby Hazrat Nizamuddin Dargah — the 14th-century Sufi shrine of Khwaja Nizamuddin Auliya. Learn about Sufi traditions, see the tomb of poet Amir Khusro, and experience the spiritual atmosphere. On Thursday evenings, attend a qawwali performance." },
      { day: "1:30 PM", title: "Connaught Place", description: "End at Connaught Place — the colonial-era commercial heart of Delhi designed in Georgian style, now a bustling shopping and dining district. Tour concludes with optional lunch recommendations." },
    ],
    image: "https://images.unsplash.com/photo-1587135941948-670b381f08ce?w=800&q=80",
  },
  {
    id: "agra-food-walk",
    name: "Agra Street Food & Bazaar Walk",
    category: "food-heritage",
    duration: "3 Hours",
    price: 35,
    originalPrice: 55,
    currency: "USD",
    description: "Explore Agra's hidden food scene — petha sweets, bedai breakfast, chaat specialties, and the Sadar Bazaar.",
    longDescription: "Agra is famous for the Taj Mahal, but locals know it for its distinctive food scene. This 3-hour guided walk takes you to family-run petha shops (the signature white squash sweet of Agra), traditional bedai and kachori breakfast joints, Mughlai kebab houses, and the bustling Sadar Bazaar for local handicrafts including marble inlay items.",
    highlights: ["Petha tasting (Agra specialty)", "Bedai kachori breakfast", "Dalmoth snacks", "Mughlai kebabs", "Sadar Bazaar shopping"],
    included: ["Expert food guide", "All food tastings (8+ items)", "Bottled water", "Hotel pickup in Agra"],
    excluded: ["Shopping purchases", "Additional items", "Tips"],
    itinerary: [
      { day: "8:30 AM", title: "Bedai Breakfast", description: "Start with an authentic Agra breakfast at a 100-year-old shop: bedai (a puffed bread) with spicy aloo sabzi and jalebi — a breakfast combo unique to Agra." },
      { day: "9:30 AM", title: "Panchhi Petha", description: "Visit the legendary Panchhi Petha (since 1926), the most famous of Agra's petha makers. Taste varieties including plain, kesar (saffron), chocolate, and angoori petha made from ash gourd." },
      { day: "10:30 AM", title: "Dalmoth & Namkeen", description: "Visit Deviram Sweets for Agra's famous dalmoth — a spicy, crunchy savory mix of lentils, nuts, and spices that has been made for over 100 years." },
      { day: "11:00 AM", title: "Mughlai Kebabs", description: "Sample Mughlai cuisine at a historic kebab house near Jama Masjid — seekh kebabs, shami kebabs, and biryani descending from Mughal royal kitchens." },
      { day: "11:45 AM", title: "Sadar Bazaar", description: "Walk through Sadar Bazaar for shopping — marble inlay crafts, leather goods, and Mughlai embroidery. Tour concludes here or optional drop-off." },
    ],
    image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=800&q=80",
  },
  {
    id: "agra-heritage-walk",
    name: "Agra Hidden Heritage Walk",
    category: "food-heritage",
    duration: "4 Hours",
    price: 40,
    originalPrice: 60,
    currency: "USD",
    description: "Beyond the Taj Mahal — discover Agra's lesser-known gems: Itimad-ud-Daulah (Baby Taj), Mehtab Bagh, Chini Ka Rauza, and Mughal-era workshops.",
    ...
    highlights: ["Itimad-ud-Daulah (Baby Taj)", "Mehtab Bagh Taj views", "Chini Ka Rauza", "Marble inlay workshop", "Yamuna riverfront"],
    included: ["Expert heritage guide", "All monument entries", "Marble workshop visit", "Bottled water", "Transportation"],
    excluded: ["Purchases at workshop", "Meals", "Tips"],
    itinerary: [
      { day: "2:00 PM", title: "Itimad-ud-Daulah (Baby Taj)", description: "Begin at Itimad-ud-Daulah — often called the 'Baby Taj' as it's believed to have inspired the Taj Mahal. Built by Empress Nur Jahan for her father, this 1628 tomb features the first pietra dura (inlay) work in India and is often considered more beautiful in detail than the Taj itself." },
      { day: "3:00 PM", title: "Chini Ka Rauza", description: "Visit the largely overlooked Chini Ka Rauza — the tomb of Afzal Khan, a Persian poet and Shah Jahan's prime minister. Notable for its Persian-style glazed tile work (chini) — the only monument in India with such extensive Persian tile decoration." },
      { day: "3:45 PM", title: "Marble Inlay Workshop", description: "Visit a family-run marble inlay workshop where artisans demonstrate the ancient pietra dura technique used in the Taj Mahal — cutting and setting semi-precious stones (lapis, carnelian, malachite, mother-of-pearl) into marble to create floral designs." },
...
export const testimonials: Testimonial[] = [
  {
    ...
    tourName: "Sunrise Taj Mahal Experience",
    avatar: "SM",
  },
  {
    id: "t2",
    ...
    tourName: "Royal Mughal Experience",
    avatar: "JC",
  },
  {
    id: "t3",
...
export interface CarRental {
  ...
  ac: boolean;
  image: string;
  // Variant photo slots — additional images of the same model.
  // Falls back to [image] when not provided. Drop more URLs here as real photos arrive.
  images?: string[];
...
const STD_ROUTES = [
  ...
  { from: "Agra", to: "Jaipur", distance: "240 km", priceOneWay: 0, priceRoundTrip: 0, duration: "4 hours" },
  { from: "Delhi Airport", to: "City Hotel", distance: "30 km", priceOneWay: 0, priceRoundTrip: 0, duration: "45 min" },
];
...
export const carRentals: CarRental[] = [
  // ===== LUXURY SUVs =====
  {
    ...
    ac: true,
    tag: "Flagship Luxury",
    image: "https://images.unsplash.com/photo-1732347700505-e1231e0f7c94?w=800&q=80",
    description: "Mercedes-Benz's flagship full-size luxury SUV. Three rows of plush leather seating, an opulent cabin, and a commanding presence — chauffeured for VIP comfort.",
    features: ["Three-row leather cabin", "6 passengers + chauffeur", "AIRMATIC suspension", "Burmester audio", "Panoramic sunroof", "Refrigerated console"],
    routes: STD_ROUTES,
  },
  {
    id: "bmw-7-series",
    ...
    ac: true,
    tag: "Executive Class",
    image: "https://images.unsplash.com/photo-1627936354732-ffbe552799d8?w=800&q=80",
    description: "BMW's flagship luxury saloon — quintessential executive transport with rear-cabin opulence, ambient theatre lighting, and a whisper-quiet ride.",
    features: ["Executive lounge seating", "4 passengers + chauffeur", "Rear theatre screen", "Massage seats", "Bowers & Wilkins audio", "Crystal switchgear"],
    routes: STD_ROUTES,
  },
  {
    id: "range-rover",
    ...
    ac: true,
    tag: "Iconic Luxury",
    image: "https://images.unsplash.com/photo-1549632891-a0bea6d0355b?w=800&q=80",
    description: "The icon of British luxury SUVs. Effortlessly blends off-road capability with rear-cabin grandeur — perfect for Rajasthan getaways and city VIP transfers.",
    features: ["Hand-crafted leather cabin", "4 passengers + chauffeur", "Air suspension", "Meridian audio", "Heated rear seats", "Privacy glass"],
    routes: STD_ROUTES,
  },
  ...
  // ===== LUXURY SEDANS =====
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1652453822981-653a9a522a5b?w=800&q=80",
      "https://images.unsplash.com/photo-1757782630151-8012288407e1?w=800&q=80",
    ],
    description: "The benchmark luxury executive sedan. Plush leather interiors, whisper-quiet cabin, and a chauffeur-driven experience for business and special occasions.",
    features: ["Leather interiors", "3 passengers + chauffeur", "Climate control", "Rear entertainment", "Complimentary water", "Wi-Fi available"],
    routes: STD_ROUTES,
  },
  {
    id: "mercedes-sclass",
    ...
    ac: true,
    tag: "Ultimate Luxury",
    image: "https://images.unsplash.com/photo-1757782630151-8012288407e1?w=800&q=80",
    description: "The pinnacle of luxury sedans. Reclining rear seats, executive cabin tech, and a ride that redefines smooth — reserved for the most important journeys.",
    features: ["Executive rear lounge", "3 passengers + chauffeur", "Reclining rear seats", "MBUX rear screens", "Burmester 4D audio", "Massage & ventilation"],
    routes: STD_ROUTES,
  },
  {
    id: "bmw-5-series",
    ...
    ac: true,
    tag: "Business Class",
    image: "https://images.unsplash.com/photo-1652890041546-2de2829c43b5?w=800&q=80",
    description: "BMW's renowned executive saloon. The perfect blend of dynamic driving, refined comfort, and quiet sophistication for premium intercity travel.",
    features: ["Premium leather cabin", "4 passengers + chauffeur", "Adaptive suspension", "Harman Kardon audio", "Ambient lighting", "Heated rear seats"],
    routes: STD_ROUTES,
  },
  {
    id: "audi-a6",
    ...
    capacity: "4 Passengers",
    ac: true,
    tag: "Refined Elegance",
    image: "https://images.unsplash.com/photo-1561924563-d9ad0f32b23f?w=800&q=80",
    description: "Audi's elegant luxury sedan. Quattro all-wheel drive, refined cabin technology, and understated sophistication — ideal for business travel.",
    features: ["Virtual cockpit", "4 passengers + chauffeur", "Quattro AWD", "Bang & Olufsen audio", "Matrix LED lighting", "Climate control"],
    routes: STD_ROUTES,
  },
  ...
  // ===== LUXURY VANS =====
  {
    ...
    ac: true,
    tag: "VIP Lounge",
    image: "https://plus.unsplash.com/premium_photo-1664302152991-d013ff125f3f?w=800&q=80",
    description: "Mercedes-Benz luxury van with a private-jet-like cabin. Captain's chairs, conference seating, and refined ride quality for VIP groups and family travel.",
    features: ["Conference-style seating", "7 passengers + chauffeur", "Captain leather seats", "Privacy curtains", "Premium audio", "Refrigerated console"],
    routes: STD_ROUTES,
  },
  {
    id: "toyota-vellfire",
    ...
    images: [
      "https://images.unsplash.com/photo-1675311149330-ff19be4aa6be?w=800&q=80",
      "https://plus.unsplash.com/premium_photo-1664302152991-d013ff125f3f?w=800&q=80",
    ],
    description: "The flagship Toyota luxury people mover. Captain seats with ottomans, whisper-quiet cabin, and a chauffeur-driven experience reserved for our most discerning guests.",
    features: ["Captain leather seats with ottoman", "6 passengers + chauffeur", "Twin moonroof", "JBL premium audio", "Ambient lighting", "Complimentary refreshments"],
    routes: STD_ROUTES,
  },
  {
    id: "toyota-coaster",
    ...
    ac: true,
    tag: "Group Luxury",
    image: "https://images.unsplash.com/photo-1746985094087-e703bf52c71b?w=800&q=80",
    description: "Toyota's premium minibus with executive seating. Plush reclining chairs, large windows, and Toyota reliability — ideal for VIP group transfers.",
    features: ["Executive recliner seating", "13 passengers + driver", "Large panoramic windows", "Individual AC vents", "Onboard entertainment", "Premium luggage hold"],
    routes: STD_ROUTES,
  },
  {
    id: "kia-carnival",
    ...
    ac: true,
    tag: "Premium MPV",
    image: "https://images.unsplash.com/photo-1709791195523-4e9382c2dc6b?w=800&q=80",
    description: "Kia's premium MPV with limousine-style rear cabin. Independent captain seats, plush ride, and modern luxury — a favorite for executive family travel.",
    features: ["VIP captain seats", "7 passengers + chauffeur", "Reclining rear seats", "Premium leather", "Wireless charging", "Dual sunroof"],
    routes: STD_ROUTES,
  },
  {
    id: "toyota-hiace",
    ...
    ac: true,
    tag: "Tour Favourite",
    image: "https://plus.unsplash.com/premium_photo-1694535048010-635c39ba7c91?w=800&q=80",
    description: "Toyota's iconic premium van — favoured by tour operators worldwide. Spacious, durable, and outfitted with comfortable touring seats.",
    features: ["Touring recliners", "10 passengers + driver", "Individual AC vents", "Generous luggage area", "Music system", "Curtains & reading lights"],
    routes: STD_ROUTES,
  },
  {
    ...
    ac: true,
    tag: "Premium Group",
    image: "https://images.unsplash.com/photo-1656426650699-a76ffe479608?w=800&q=80",
    description: "Mercedes-Benz Sprinter with a fully appointed luxury interior. Conference seating, mood lighting, and a smooth highway ride for premium group transfers.",
    features: ["Conference-style seats", "12 passengers + driver", "Mood lighting", "Premium audio", "USB charging at every seat", "Privacy curtains"],
    routes: STD_ROUTES,
  },
  ...
  // ===== PREMIUM SUVs =====
  {
    ...
    ac: true,
    tag: "Premium Pick",
    image: "https://images.unsplash.com/photo-1664783856972-ac9922d7b2d3?w=800&q=80",
    images: [
  ...
  },
  {
    ...
    ac: true,
    tag: "Hybrid Luxury",
    image: "https://images.unsplash.com/photo-1748215210939-ad8b6c8c086d?w=800&q=80",
    description: "The newest premium MPV from Toyota. Hybrid efficiency, captain-style seating, and a refined cabin make it ideal for executive transfers and family luxury travel.",
    features: ["Captain seats with ottoman", "6 passengers + chauffeur", "Hybrid powertrain", "Panoramic roof", "Wireless charging", "Premium audio"],
    routes: STD_ROUTES,
  },
  ...
  // ===== PREMIUM COACHES =====
  {
    ...
    description: "India's modern premium minibus. Aircraft-style cabin, push-back recliner seats, and a smooth highway ride — the new standard for group luxury travel.",
    features: ["Aircraft-style cabin", "12 passengers + driver", "Push-back recliner seats", "Individual AC vents", "Reading lights", "Generous luggage area"],
    routes: STD_ROUTES,
  },
  {
    id: "tempo-traveller",
    ...
    description: "The trusted workhorse of Indian group travel. Available in 9, 12, and 17-seater layouts with push-back seats and ample luggage room.",
    features: ["Push-back seats", "9, 12 & 17-seat options", "Individual AC vents", "Large luggage area", "Music system", "Curtains & LED lights"],
    routes: STD_ROUTES,
  },
  ...
  // ===== COACHES =====
  {
    ...
    ac: true,
    tag: "Large Groups",
    image: "https://plus.unsplash.com/premium_photo-1676573201285-20af67891d0a?w=800&q=80",
    description: "Volvo's luxury touring coach for large groups. Recliner seats, panoramic windows, on-board washroom on select coaches — ideal for weddings and corporate tours.",
    features: ["Volvo air suspension", "45 passengers + driver", "Push-back recliner seats", "Onboard entertainment", "Climate-controlled cabin", "Generous luggage hold"],
    routes: STD_ROUTES,
  },
  ...
  // ===== SUVs =====
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1748215210939-ad8b6c8c086d?w=800&q=80",
    ],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1710909637342-4f7e8e90ef2b?w=800&q=80",
    description: "Kia's modern crossover MPV with three rows of comfortable seating. Perfect for families wanting SUV practicality with car-like driving comfort.",
    features: ["3-row AC seating", "6 passengers + driver", "Ventilated seats", "Premium 8-speaker audio", "Wireless charging", "Sunroof"],
    routes: STD_ROUTES,
  },
  ...
  },
  {
    ...
    ac: true,
    tag: "Value Comfort",
    image: "https://images.unsplash.com/photo-1588036873025-7261a5647adf?w=800&q=80",
    description: "Hyundai's modern compact sedan. Refined ride quality, generous boot space, and a feature-rich cabin — ideal for couples and small families.",
    features: ["AC cabin", "4 passengers + driver", "Touchscreen infotainment", "Rear AC vents", "Power windows", "Spacious boot"],
    routes: STD_ROUTES,
  },
  {
    id: "swift-dzire",
  ...
  },
  {
    ...
    description: "Toyota's premium hatchback option for city tours and short transfers. Comfortable ride, frugal fuel economy, and dependable Toyota service.",
    features: ["AC cabin", "4 passengers + driver", "Smart hybrid mild-hybrid tech", "Touchscreen infotainment", "Cruise control", "Fuel efficient"],
    routes: STD_ROUTES,
  },
];
